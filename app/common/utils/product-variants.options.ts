...
export const productVariants: ProductCardType[] = [
  {
    title: "EOLO mini",
    description:
    ...
    openModal: () => {},
    images: [
      "/images/layouts/productos/eolo/variants/Gherbezza-4.webp",
      "/images/layouts/productos/eolo/variants/Gherbezza-5.webp",
      "/images/layouts/productos/eolo/variants/Gherbezza-4.webp",
      "/images/layouts/productos/eolo/variants/Gherbezza-4.webp",
    ],
  },
